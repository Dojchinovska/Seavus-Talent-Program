...
import com.talent.noteswithoutdatabase.service.NoteService;
...
public class NotesController {
    ...
    public Optional<Note> updateNote(@PathVariable("id") Long id, @RequestBody Note note) throws Exception {
